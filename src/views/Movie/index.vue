  ...
  <div id="main">
    ...
    <div id="content">
      <div class="movie_menu">
        <router-link tag="div" to="/movie/city" class="city_name"><span>大连</span><i class="iconfont"></i></router-link>
...
.movie_menu .city_name{margin-left:20px;height:100%;line-height:45px;border-bottom:1px #e6e6e6 solid;}
...
.movie_menu .search_entry{font-size:24px;color:red;}
</style>