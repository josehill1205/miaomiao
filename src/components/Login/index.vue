<template>
    <div class="login_body">
      ...
      <div>
        <input type="text" class="login_text" placeholder="请输入你的密码">
      </div>
      <div class="login_btn">
...
.login_body .login_text{width:100%;height:40px;border:none;border-bottom:1px #ccc solid;margin-bottom:5px;}
.login_body .login_btn{height:50px;margin:10px;}
.login_body .login_btn input{width:100%;height:100%;background:#e54847;border-radius:3px;border:none;}
